...
import springboot.elasticsearch.model.People;
import springboot.elasticsearch.model.SearchResult;
import springboot.elasticsearch.util.RandomUtil;
...
//            jsonData = ;
            ...
            System.out.println(Strings.toString(jsonBuild));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return jsonBuild;
